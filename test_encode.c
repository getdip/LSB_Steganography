...
int main(int argc, char* argv[])
{
   ...
   
   {
        ...
        if(read_and_validate_encode_args(argv,&infoptr) == e_success )       // validate the CLA inputs i.e the .bmp files and .txt files
  ...
  else if  (check_operation_type(argv) == e_decode)                         //if DECODING is selected
