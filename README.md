...
Note: The input image file format must be <filename>.bmp (Bitmap). Bitmap format stores image data without any compression techniques that reduces file size.
